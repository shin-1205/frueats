...
<div id="product-content" class="fadeInTrigger">
  <div class="container">
    <div class="product-wrap">
      ...
      <section class="product-content-main">
        ...
        <div class="product-main-left">
          <ul class="slide">
            <li class="item"><img src="<?php the_field('item画像1'); ?>" alt="" /></li>
        ...
        <div class="product-main-right">
          ...
          <form class="form">
            ...
            <div class="inputGroup">
              ...
              <label for="radio1">
                <div class="radio-top">normal purchase<h4>$<?php the_field('値段'); ?><span>tax included</span></h4>
                </div>
              </label>
            </div>
            <div class="inputGroup">
              ...
              <label for="radio2">
                <div class="radio-top">
                  purchase 10% OFF <h4>$<?php the_field('値段2'); ?><span>tax included</span></h4>
                </div>
      ...
      <section class="product-customer">
        ...
        <div class="product-customer-bottom">
        ...
        <div class="product-customer-review-bottom">
