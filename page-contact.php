...
<div class="contact-wrap">
  ...
  <div class="contact-main">
    ...
    <h3>Please check <a href="<?php bloginfo('url');?>/faq">FAQ</a> before contacting us. <br>
      ...
      If you do not receive a reply within 3 business days, it is possible that the email sent from FruEats was not
      received. <br>
      Please check your spam folder and make sure that you can receive emails from "support@frueats.jp". </h3>
